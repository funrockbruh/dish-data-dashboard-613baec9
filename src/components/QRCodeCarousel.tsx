...
export const QRCodeCarousel = () => {
  ...
  return <section className="py-24 px-4 bg-gradient-to-b from-blue-50/50 to-purple-50/50">
      <div className="container mx-auto">
        ...
        loop: true
          ...
          <CarouselContent className="-ml-2 md:-ml-4">
            {qrCodeItems.map((item, index) => <CarouselItem key={index} className="pl-2 md:pl-4 basis-full md:basis-1/2 lg:basis-1/3">
                <div className="p-1">
