...
export const MenuSidebar = ({
  ...
  return (
    <>
        ...
        <SheetContent side="right" className="w-[300px] p-0 bg-black text-white border-gray-800">
          <div className="flex flex-col h-full rounded-2xl">
            ...
            {(socialMedia.instagram || socialMedia.facebook || socialMedia.tiktok || socialMedia.whatsapp) && (
              <div className="flex justify-center gap-4 py-4 border-t border-gray-800 rounded-t-2xl">
                {restaurant?.social_instagram && (
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-10 w-10 text-white cursor-pointer hover:text-white/80 transition-colors" onClick={() => handleSocialClick(restaurant.social_instagram)}>
                ...
                {restaurant?.social_facebook && (
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-10 w-10 text-white cursor-pointer hover:text-white/80 transition-colors" onClick={() => handleSocialClick(restaurant.social_facebook)}>
                ...
                {restaurant?.social_tiktok && (
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-10 w-10 text-white cursor-pointer hover:text-white/80 transition-colors" onClick={() => handleSocialClick(restaurant.social_tiktok)}>
                ...
                {restaurant?.social_whatsapp && (
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="h-10 w-10 text-white cursor-pointer hover:text-white/80 transition-colors" onClick={handleContactClick}>
                      <g fill="currentColor">
            ...
            <div className="p-6 border-t border-gray-800 rounded-2xl">
              {isAuthenticated ? (
                <button className="w-full py-2 px-4 rounded-lg bg-red-600 hover:bg-red-700 text-white" onClick={handleSignOut}>
                  Sign Out
                </button>
              ) : (
                <button className="w-full py-2 px-4 rounded-lg bg-blue-600 hover:bg-blue-700 text-white" onClick={handleSignIn}>
                  Sign In
                </button>
              )}
            </div>
      ...
      {isAuthenticated && restaurant?.restaurant_name && renewalDate && userId && (
        <RenewalPopup 
